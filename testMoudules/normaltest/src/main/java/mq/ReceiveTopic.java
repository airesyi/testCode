...
public class ReceiveTopic implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            connection.setClientID("testID123");
            ...
            destination = session.createTopic("testTopicAAAA");
            Topic topic = session.createTopic("testTopicAAAA");
            consumer = session.createDurableSubscriber(topic, "aaaa");
